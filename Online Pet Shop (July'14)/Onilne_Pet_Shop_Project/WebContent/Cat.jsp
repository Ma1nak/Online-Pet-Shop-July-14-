		  ...
		  try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from Details where itemcategory='Cat'");
	...
	while(rs.next())
	{
		...
		<a href="<%=s2%>.jsp"><img id="roundEdge" src="images/<%=s2%>.jpg" width="140" height="250" alt="Pet Shop" title="Pet Shop"></a>
		<h2><%=s2%></h2>
		<input type="hidden" name="itemcatagory" value='<%= s1 %>'/>
