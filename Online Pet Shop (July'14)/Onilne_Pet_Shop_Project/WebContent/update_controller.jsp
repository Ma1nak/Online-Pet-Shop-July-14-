...
<%
  ...
  try
  {
	  ...
	  PreparedStatement ps1=con.prepareStatement("update Details set itemid=?,price=? where itemcategory=? and itemname=?");
		ps1.setString(1, id);
		...
		int i=ps1.executeUpdate();
		 if(i>0)
		 {
			...
			<br>
			 			...
			 			<br />
			 			<br /><center><img src="images/items_updated_banner.PNG" /></center>
			<%
		 }
		 else
		 {
	...
	{
		e.printStackTrace();
		 out.print("<br> EXCEPTION OCCURED.....!!!!!");
	}
%>
</body>
</html>